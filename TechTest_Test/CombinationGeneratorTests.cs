...
namespace TechTest_Tests
{
    ...
    public class CombinationGeneratorTests
    {
        ...
        public void Create_InvalidRange_Throws()
        {
            ...
            Assert.ThrowsException<System.ArgumentException>(() => new CombinationGenerator(2, 1, 1));
        }
        ...
        public void Create_InvalidReturnSize_Throws()
        {
            ...
            Assert.ThrowsException<System.ArgumentException>(() => new CombinationGenerator(1, 10, 11));
        }
        ...
        public void GetAcending_ReturnLengthEqualsCombinationLength()
        {
            ...
            var combination = new CombinationGenerator(min, max, combinationLength).GetNewAscending();
        ...
        public void GetDescending_ReturnLengthEqualsCombinationLength()
        {
            ...
            var combination = new CombinationGenerator(min, max, combinationLength).GetNewDescending();
